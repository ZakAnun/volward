...
void main() {
  ...
  testWidgets('a partial size is marked approximate', (tester) async {
    await pumpPanel(tester, summary: summaryWithItems(items: const [archiveDir]));
  ...
  testWidgets('maxItems caps the rendered rows', (tester) async {
    ...
    expect(find.byKey(LargestItemsPanel.rowKey('/Users/me/item2')), findsOneWidget);
    expect(find.byKey(LargestItemsPanel.rowKey('/Users/me/item3')), findsNothing);
