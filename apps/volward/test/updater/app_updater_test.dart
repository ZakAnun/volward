...
ReleaseInfo _release({String tag = 'v0.0.2'}) {
  return ReleaseInfo(
    tagName: tag,
    version: '0.0.2',
...
void main() {
  ...
  test('no matching asset becomes error with kind', () async {
    final updater = AppUpdater(
      localVersionReader: _FakeLocal('0.0.1'),
      versionSource: _FakeSource(
        const ReleaseInfo(
          tagName: 'v0.0.2',
          version: '0.0.2',
